...
# Commented out for Docker compatibility with gRPC 1.60.0
# try:
...
class UsuariosServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.DeactivateUser = channel.unary_unary(
                ...
                request_serializer=users__pb2.DeactivateUserRequest.SerializeToString,
                response_deserializer=users__pb2.User.FromString,
                _registered_method=True)
...
def add_UsuariosServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'DeactivateUser': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=users__pb2.DeactivateUserRequest.FromString,
                    response_serializer=users__pb2.User.SerializeToString,
            ),
    ...
    # server.add_registered_method_handlers('ong.users.UsuariosService', rpc_method_handlers)  # Commented for Docker compatibility
...
class UsuariosService(object):
    ...
    def DeactivateUser(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/ong.users.UsuariosService/DeactivateUser',
            users__pb2.DeactivateUserRequest.SerializeToString,
            users__pb2.User.FromString,
            options,
            channel_credentials,
            insecure,
